        ...
        <ul class="navbar-nav mr-auto ">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="../gigaticket/index.php">
                Atrás
              </a>
            </div>
          </li>
    ...
    <div class="container text-center">
      <div id="inicio" class="container"><br>
        ...
        <div class="jumbotron  "> <!--A jumbotron indicates a big grey box for calling extra attention to some special content or information. -->
          <h4> Enhorabuena, bienvenidx usuarix </h4><br>
          <h5> ¡Ya formas parte de nosotros! </h5> <br>
          <div class="row justify-content-center m-3">
            <div class="col-sm-3 text-center">
              <a href='sesiones/cerrarSesionUGT.php' class="btn btn-outline-warning mt-5">
                Cerrar Sesión
              </a>
            </div>
          </div>
        </div>            
        <img src="../imagenes/door2.jpg" class="door my-3 rounded mx-auto d-block img-fluid" alt="welcome" width="500" height="400"> <!--img-fluid resizes the img -->
      </div>
    </div>
    <!-- Finish Container-->  

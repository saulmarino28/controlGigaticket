...
<body >
      ...
      <div class="collapse navbar-collapse " id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto ">
          <li class="nav-item active">
            <a class="nav-link" href="#"><strong>Eliminar Acceso del Usuario</strong> <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
    ...
    <!-- Start alert status-->
    <div class="container" id="alertDeleteAccess">
        ...
        <div class="modal-dialog  ">
          <div class="modal-content bg-danger border-dark">
            <div class="modal-header">
              <h5 class="modal-title" id="deleteModalLabel">Eliminar Acceso del Usuario</h5>
            ...
            <div class="modal-body"> 
              ...
              <h4>¿Estas seguro que quieres <strong>ELIMINAR</strong> este Acceso?</h4>
          </div>
                ...
                <table class="table table-primary table-hover table-bordered">
                          <thead class="thead-dark text-center">
                              <tr class="">
                                  ...
                                  <th>Hora ingreso</th>
                                  <th>Hora egreso</th>
                                  <th>Eliminar Acceso</th>

                              </tr>
                          </thead>
                     <tbody class="text-center" id="tableDeleteAccess">                         
...
<script type="text/javascript" src="../js/deleteAccess.js"></script>
</body>
</html>
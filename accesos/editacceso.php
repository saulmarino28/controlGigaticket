      ...
      <div class="collapse navbar-collapse " id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto ">
          <li class="nav-item active">
            <a class="nav-link" href="#"><strong>Editar Acceso del Usuario</strong> <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
    ...
    <!-- Modal finish -->
     ...
     <!-- Table start-->
      ...
      <div class="container mt-5 table-responsive-xl"> 
        <input class="form-control col-md-5" id="myInput" type="text" placeholder="Search... Enter name, space, date "><br>
        <div class="row">
          <div class="col-xl-12">

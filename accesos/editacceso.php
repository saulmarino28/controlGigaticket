...
<html>
  ...
  <body >
        ...
        <ul class="navbar-nav mr-auto ">
          <li class="nav-item active">
            <a class="nav-link" href="#">
              <strong>Editar Acceso del Usuario</strong>
    ...
    <!-- Start alert status-->
    <div class="container" id="alertEditAccess">
                ...
                <div class="row justify-content-center ">
                  ...
                  <div class="col-sm-5">             
                    ...
                    <div class="form-group">
                      ...
                      <div class="invalid-feedback">
                        Por favor escribe una la fecha de egreso correcta.
                      </div>
                      <div id="wrongFecha" name="wrongFecha" class="text-danger invisible "> 
                        <h6>
                          Ingresa una fecha de egreso mayor que la fecha de ingreso
                        </h6>
                      </div>
                    </div>
                  </div>
    ...
    <div class="container mt-5 table-responsive-xl"> 
      <input class="form-control col-md-5" id="myInput" type="text" placeholder="Search... Enter name, space, date ">
      <br>
      <div class="row">
        <div class="col-xl-12">
          <table class="table table-primary table-hover table-bordered">
            ...
            <tbody class="text-center" id="tableEditAccess">

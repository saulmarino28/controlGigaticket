...
<body >
  ...
  <div class="row justify-content-center" >
   ...
   <form method="POST" action="#" class="needs-validation my-2" id="horarios" novalidate>
      <div class="row justify-content-center ">
         <div class="col-sm-5">
          ...
          <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="space" placeholder="" name="space" required>
                     <div class="valid-feedback">Válido.</div>
                     <div class="invalid-feedback">El nombre del espacio debe tener de 3-10 dígitos.</div>
                  </div> 
                  <div class="form-group">
                     <label for="fecha_i">Fecha de ingreso:</label>
                     <input type="date" class="form-control" id="fecha_i" placeholder="Ingresa fecha" name="date" required>
                     <div class="valid-feedback">Válido.</div>
                     <div class="invalid-feedback">Ingresa una fecha correcta.</div>
                  </div>
                  <div class="form-group">
                     <label for="hora_i">Hora inicial:</label>
                     <input type="time" class="form-control" id="hora_i" placeholder="Ingresa hora" name="hora_i" required>
                     <div class="valid-feedback">Válido.</div>
          ...
          <div class="col-sm-5">
            ...
            <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <input type="time" class="form-control" id="hora_f" placeholder="Ingresa hora" name="hora_f" required>
                     <div class="valid-feedback">Válido.</div>
                     <div class="invalid-feedback">Ingresa una hora correcta.</div>
                  </div>     
       ...
       <div class="row justify-content-center my-4  ">
          <div class="col-sm-5 text-center">               
                   <div class="form-group  ">
                      <button type="submit" class="btn btn-outline-info btn-lg btn-block  " id="horarios" name="enviar">
                        Agregar Usuario
                      </button>
                   </div> 
               </div>

...
<html>
  ...
  <body >
    ...
    <div class="container ">  
      ...
      <div class="row justify-content-center m-2">
        <div class="col-sm-3 text-center">                  
          <div class="form-group">
            <button  class="btn btn-outline-info btn-lg btn-block m-3  " name="btn-actualizar" id="btn-actualizar">
              Actualizar tabla
            </button>
          </div> 
        </div>
    ...
    <script type="text/javascript" src="../js/editClient.js"> 
    </script>
    <script type="text/javascript" src="../js/searchSpace.js">
    </script>
  </body>
</html>